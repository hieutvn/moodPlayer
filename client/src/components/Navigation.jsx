    ...
    return (
        ...
        <div className={styles.navigation_wrapper}>
            ...
            <div className={styles.icon_wrapper} onClick={() => setHistoryToggled(!isHistoryToggled)}>
                <HistoryIcon alt='Listening History' className={`${styles.icon} ${isHistoryToggled ? styles.toggled : styles.collapsed}`} />
            </div>
                ...
                <div className={styles.search_bar_container}>
                    <div className={styles.search_wrapper}>
                        <div className={styles.icon_wrapper} onClick={() => setSearchToggled(!isSearchToggled)}>
                            <SearchIcon alt='Search' className={`${styles.icon} ${isSearchToggled ? styles.toggled : styles.collapsed}`} />
                        </div>
